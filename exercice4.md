...
- html5up-paradigm-shift.zip pour nginx-web5
    # docker cp /c/Users/Administrateur/Desktop/LAHO_2026-07-06_Admin-Cloud/05-Docker/exercice_bis/files_tp_conteneur/html5up-paradigm-shift/. nginx-web5:/usr/share/nginx/html/
- Stopper, ensuite, ces différents conteneurs.
    # docker stop nginx-web3 && docker stop nginx-web4 && docker stop nginx-web5